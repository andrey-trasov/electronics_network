...
from electronics.views import (
    ...
    SupplierListApiView,
    SuppliernRetrieveAPIView,
    SupplierUpdateAPIView,
    SupplierDestroyAPIView,
    ArrearsCreateApiView,
    ArrearsListApiView,
    ArrearsRetrieveAPIView,
    ArrearsDestroyAPIView,
    ContactsViewSet,
    ProductsViewSet,
    ArrearsUpdateAPIView,
)
...
urlpatterns = [
    ...
    path(
        "electronics_update/<int:pk>/",
        ArrearsUpdateAPIView.as_view(),
        name="electronics_update",
    ),
    path(
        "arrears_delete/<int:pk>/",
        ArrearsDestroyAPIView.as_view(),
        name="arrears_delete",
    ),
]
